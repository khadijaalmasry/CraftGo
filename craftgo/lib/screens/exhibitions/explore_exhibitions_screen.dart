...
class ExploreExhibitionsScreen extends StatefulWidget {
  const ExploreExhibitionsScreen({super.key});

  @override
  State<ExploreExhibitionsScreen> createState() =>
      _ExploreExhibitionsScreenState();
}
              ...
              children: [
                Row(
                  children: [
                    ...
                    Text(
                      isFull
                          ? t('ممتلئ - متاح للاحتياط',
                              'Full - Standby Available', appState)
                          : t('متاح للتسجيل الأساسي',
                              'Available for Registration', appState),
                      style: GoogleFonts.cairo(
                        color: isFull ? Colors.amber.shade700 : Colors.green,
                        fontWeight: FontWeight.bold,
                        fontSize: 12,
                ...
                Container(
                  ...
                  child: Text(
                    isFull
                        ? t('احتياط متاح', 'Standby Open', appState)
                        : t('مقاعد متاحة', 'Seats Available', appState),
                    style: GoogleFonts.cairo(
                      color: isFull
